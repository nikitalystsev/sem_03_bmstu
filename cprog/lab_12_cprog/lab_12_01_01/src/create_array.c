...
int read_array(FILE *file, const char *const file_name,
int *const ptr_start, int *const ptr_end)
{
    int rc = 0;
...
int create_array(FILE *file, const char *const file_name,
int **pb_src, int **pe_src)
{
    int rc;
    int count_elements;
